  ...
  @defer(on immediate){
      <div class="grid grid-cols-1 my-10">
        ...
        <div class="flex flex-col md:flex-row rounded py-10">
          ...
          <div
            class="z-[1] w-full md:w-[70%] flex flex-col justify-between order-1        md:order-none gap-4 p-5 border-b border-x md:border-0 dark:border-gray-700"
            [ngClass]="{
              'md:order-2': project.toRight,
              'md:order-none': !project.toRight,
              'md:text-end': project.toRight
            }"
          >
            <div>
              <p class="dark:text-primary-400 text-primary-600 text-sm font-bold mb-2">
                Featured Project
              </p>
          ...
          <div
            ...
            [ngClass]="{
              'md:-ml-10': !project.toRight,
              'md:-mr-10': project.toRight
            }"
          >
            ...
            <img
              skeleton
              class="md:rounded z-0 max-w-full w-full h-48 object-cover"
              draggable="false"
              [src]="project.image"
              [alt]="project.title"
            />
