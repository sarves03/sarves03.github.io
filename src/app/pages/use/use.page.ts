  ...
  template: `<div>
    ...
    <div class="flex flex-col gap-7">
      ...
      <p class="dark:text-white text-black">
        This website is created with Angular and Tailwind CSS. It's hosted on
        AWS S3, and if you're curious, feel free to explore the source code on
        <a
          class="underline"
          href="https://github.com/marckevinflores/kevinflor.es"
          target="_blank"
          >GitHub</a
        >.
      </p>
      ...
      <p class="dark:text-white text-black">
        ...
        <a
          ...
          >Inter</a
        >, a typeface commonly utilized by web designers.
      </p>
      <div
      ...
      >
        ...
        <p class="border-r border-gray-500 p-4 font-extrabold">
          Inter Extrabold
        </p>
      </div>
      <h2 class="text-xl font-bold dark:text-white">Colors:</h2>
      <p class="dark:text-white text-black">
        I chose this color palette, drawing inspiration from various websites to
        create the design.
      </p>
      ...
      <p class="text-black dark:text-white">
        I designed the logo myself, incorporating the first letters of my full
        name M, K, and F to create a concise design. The inspiration struck me
      ...
      <p class="text-black dark:text-white">
        I just found it here on
        <a
          class="underline"
          target="_blank"
          href="https://storyset.com/illustration/before-dawn/pana#utm_source=freepik&utm_medium=referall&utm_campaign=storiesdetail&utm_content=edit-button&utm_term=edit"
          >storyset.com</a
        >
      </p>
    </div>
